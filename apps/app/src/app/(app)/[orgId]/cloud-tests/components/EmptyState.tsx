...
import { T, Var, Branch, useGT, msg, useMessages } from 'gt-next';
  ...
  aws: [
    {
      ...
      placeholder: msg('AKIAIOSFODNN7EXAMPLE'),
  ...
  azure: [
    {
      ...
      placeholder: msg('00000000-0000-0000-0000-000000000000'),
              ...
              <div className="flex items-center gap-3">
                ...
                >
                  <img
                    ...
                    alt={gt('{shortName} logo', { shortName: m(provider.shortName) })}
                ...
                <div>
                  ...
                  <CardDescription className="mt-0.5 text-sm">
                    {awsAccountId
                      ? gt('Credentials verified • Account: {accountId}', {
                          accountId: awsAccountId,
                        })
                      : gt('Credentials verified')}
                  </CardDescription>
                </div>
              </div>
            </CardHeader>
      ...
      <div className="container mx-auto flex min-h-[600px] w-full flex-col items-center justify-center gap-8 p-4 md:p-6 lg:p-8">
        ...
        <div className="mx-auto flex max-w-2xl flex-col items-center gap-6 text-center">
          ...
          <div className="space-y-4">
            <T>
              <Branch
                branch={onBack ? 'true' : 'false'}
                true={<h1 className="text-4xl font-bold tracking-tight">Add Another Cloud</h1>}
                false={
                  <h1 className="text-4xl font-bold tracking-tight">Continuous Cloud Scanning</h1>
                }
              />
            </T>
                ...
                <CardHeader className="relative space-y-4 pb-4">
                  ...
                  >
                    <img
                      ...
                      alt={gt('{shortName} logo', { shortName: m(cloudProvider.shortName) })}
          ...
          <div className="space-y-2">
            ...
            <T>
              <p className="text-muted-foreground max-w-lg text-lg">
                <Var>{m(provider.name)}</Var> is now connected. Your first security scan is
                running...
              </p>
            </T>
          </div>
