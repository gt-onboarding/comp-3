...
export function DataTableFilterMenu<TData>({
  ...
  return (
    <div className="flex flex-wrap items-center gap-2">
      ...
      {filters.length > 0 && (
        <Button
          aria-label={gt('Reset all filters')}
          variant="outline"
          size="icon"
          className="size-8"
      ...
      <Popover open={open} onOpenChange={onOpenChange}>
        <PopoverTrigger asChild>
          <Button
            aria-label={gt('Open filter command menu')}
            variant="outline"
    ...
    case 'range': {
      ...
      return (
        <Input
          ...
          placeholder={column.columnDef.meta?.placeholder ?? gt('Enter value...')}
    ...
    case 'multiSelect': {
      ...
      return (
        <Popover open={showValueSelector} onOpenChange={setShowValueSelector}>
                ...
                <>
                  ...
                  <span className="truncate">
                    {selectedOptions.length > 1
                      ? gt('{count} selected', { count: selectedOptions.length })
          ...
          >
            <Command>
              <CommandInput placeholder={gt('Search options...')} />
              <CommandList>
                <CommandEmpty>
                  <T>No options found.</T>
                </CommandEmpty>
